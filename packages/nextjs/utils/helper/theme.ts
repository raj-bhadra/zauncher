          ...
          root: ({ theme, ownerState }) => ({
            ...
            ...(ownerState.variant === "outlined" &&
              ownerState.color === "secondary" && {
                ...
                boxShadow: `#FFF 0 1px 0 1px inset, ${alpha(theme.palette.grey[200], 0.4)} 0 -1px 0 1px inset, ${alpha(
            ...
            style: ({ theme }) => [
              {
                ...
                boxShadow: `0px 2px 2px ${alpha(theme.palette.primary[100], 0.2)}, inset 0px 4px 4px ${alpha(
                  theme.palette.primary[100],
                  0.2,
                )}`,
                fontFamily: theme.typography.fontFamilyCode,
            ...
            style: ({ theme }) => [
              {
                ...
                boxShadow: `#FFF 0 1px 0 inset, ${alpha(theme.palette.grey[200], 0.4)} 0 -1px 0 inset, ${alpha(
                  theme.palette.grey[200],
                  0.5,
                )} 0 1px 2px 0`,
                "&:hover": {
